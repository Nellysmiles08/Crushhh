...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'createProfile02',
          path: '/createProfile02',
          builder: (context, params) => const CreateProfile02Widget(),
        ),
        FFRoute(
          name: 'EditProfile',
          path: '/editProfile',
        ...
        FFRoute(
          name: 'Crushes',
          path: '/crushes',
          builder: (context, params) => const CrushesWidget(),
        ),
        FFRoute(
          name: 'School',
          path: '/school',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'School')
              : const SchoolWidget(),
        ),
        FFRoute(
          name: 'LocationSearch',
          path: '/locationSearch',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'LocationSearch')
        ...
        FFRoute(
          name: 'Matches',
          path: '/matches',
          builder: (context, params) => const MatchesWidget(),
        ),
        FFRoute(
          name: 'ForgotPassword',
          path: '/forgotPassword',
