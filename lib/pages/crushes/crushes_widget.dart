...
import 'crushes_model.dart';
export 'crushes_model.dart';

class CrushesWidget extends StatefulWidget {
  const CrushesWidget({super.key});

  @override
  State<CrushesWidget> createState() => _CrushesWidgetState();
}

class _CrushesWidgetState extends State<CrushesWidget> {
  late CrushesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrushesModel());
                ...
                children: [
                  StreamBuilder<List<CrushRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CrushRecord> listViewCrushRecordList =
                          snapshot.data!;
                      ...
                      return ListView.separated(
                        ...
                        itemCount: listViewCrushRecordList.length,
                        separatorBuilder: (_, __) => const SizedBox(height: 20.0),
                        itemBuilder: (context, listViewIndex) {
                          final listViewCrushRecord =
                              listViewCrushRecordList[listViewIndex];
                          return StreamBuilder<UserRecord>(
                            stream: UserRecord.getDocument(
                                listViewCrushRecord.crushRef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Builder(
                                          builder: (context) {
                                            if ((currentUserDocument?.crushes
                                                        .toList() ??
                                                    [])
